...
import numpy as np
from kernel import Kernel, Cauchy_Kernel
...
class SVGP(nn.Module):
    def __init__(self,distance,initial_inducing_points,fixed_inducing_points, fixed_gp_params, kernel_scale, jitter, N_train, dtype, device):
        ...
        self.kernel = Kernel(scale=kernel_scale, fixed_scale=fixed_gp_params, distance=distance,dtype=dtype, device=device).to(device)
