...
import scanpy as sc
from preprocess import normalize, inducing_points_select_tumor, get_top_down_cluster_ids
...
if __name__ == "__main__":
    ...
    inducing_points = inducing_points_select_tumor(adata=pruned_adata,distance_matrix=dist_matrix, select_feature=top_down_clusters,
                                                   all_indices=all_indices, CELLS_PER_ADDITIONAL_POINT=100)
