...
def _get_loss_plot(losses1, losses2, losses3, loss_names=['Triplet loss', 'Recon. loss', 'Total loss'],
                   xlabel='epochs'):
...
def train_triplet(model, model_path, expression_path=None, apn_lut=None, apn_lut_path=None, gene_matrix=None,
                  batch_size=128,
